...
$LLVMROOT/opt -encryption -confidentiality -steens-fast -skip-csa=true -skip-vfa=false -optimized-check=true -partitioning=true -hoist-taint-checks=true  $filewithlibc.bc -o $fileinst.bc

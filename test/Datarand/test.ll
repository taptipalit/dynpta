...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %3), !dbg !30
  ret void, !dbg !31
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %3), !dbg !47
  ret void, !dbg !48
}
...
entry:
  ...
  call void @llvm.var.annotation(i8* %iptr1, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 35), !dbg !77
  ...
  %0 = load i32, i32* %k, align 4, !dbg !82
  %add = add nsw i32 %0, 10, !dbg !83
  store i32 %add, i32* %j, align 4, !dbg !81
  %1 = load i32, i32* %k, align 4, !dbg !84
  %2 = load i32, i32* %j, align 4, !dbg !85
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), i32 %1, i32 %2), !dbg !86
  %3 = load i32, i32* %j, align 4, !dbg !87
  %cmp = icmp slt i32 %3, 100, !dbg !89
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %4 = load void (i32)*, void (i32)** %funcptr3, align 8, !dbg !103
  call void %4(i32 23), !dbg !104
  ret i32 0, !dbg !105
}

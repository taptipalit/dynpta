; ModuleID = 'demand_fields_inst.bc'
...
entry:
  ...
  %0 = getelementptr [10 x i8], [10 x i8]* @.str, i32 0, i32 0
  %1 = getelementptr [16 x i8], [16 x i8]* @.str.1, i32 0, i32 0
  call void @llvm.var.annotation(i8* %a1, i8* %0, i8* %1, i32 11), !dbg !13
  ...
  %2 = load i32*, i32** %p1, align 8, !dbg !43
  %3 = load i32, i32* %2, align 4, !dbg !44
  %4 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %4, i32 %3), !dbg !45
  %5 = load i32*, i32** %p2, align 8, !dbg !46
  %6 = load i32, i32* %5, align 4, !dbg !47
  %7 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call2 = call i32 (i8*, ...) @printf(i8* %7, i32 %6), !dbg !48
  %8 = load %struct.Student*, %struct.Student** %sptr, align 8, !dbg !49
  %pointer3 = getelementptr inbounds %struct.Student, %struct.Student* %8, i32 0, i32 0, !dbg !50
  %9 = load i32*, i32** %pointer3, align 8, !dbg !50
  %10 = load i32, i32* %9, align 4, !dbg !51
  %11 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call4 = call i32 (i8*, ...) @printf(i8* %11, i32 %10), !dbg !52
  %id5 = getelementptr inbounds %struct.Student, %struct.Student* %stud, i32 0, i32 1, !dbg !53
  %12 = load i32, i32* %id5, align 8, !dbg !53
  %13 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call6 = call i32 (i8*, ...) @printf(i8* %13, i32 %12), !dbg !54
  %14 = load %struct.Student*, %struct.Student** %sptr, align 8, !dbg !55
  %pointer7 = getelementptr inbounds %struct.Student, %struct.Student* %14, i32 0, i32 0, !dbg !56
  %15 = load i32*, i32** %pointer7, align 8, !dbg !56
  store i32* %15, i32** %localpointer, align 8, !dbg !57
  %16 = load i32*, i32** %localpointer, align 8, !dbg !58
  %17 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call8 = call i32 (i8*, ...) @printf(i8* %17, i32* %16), !dbg !59
  ret i32 0, !dbg !60
}

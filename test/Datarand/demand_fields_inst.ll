...
entry:
  ...
  call void @llvm.var.annotation(i8* %a1, i8* %0, i8* %1, i32 11)
  ...
  %call = call i32 (i8*, ...) @printf(i8* %4, i32 %3)
  %5 = load i32*, i32** %p2, align 8
  %6 = load i32, i32* %5, align 4
  %7 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call2 = call i32 (i8*, ...) @printf(i8* %7, i32 %6)
  %8 = load %struct.Student*, %struct.Student** %sptr, align 8
  %pointer3 = getelementptr inbounds %struct.Student, %struct.Student* %8, i32 0, i32 0
  %9 = load i32*, i32** %pointer3, align 8
  %10 = load i32, i32* %9, align 4
  %11 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call4 = call i32 (i8*, ...) @printf(i8* %11, i32 %10)

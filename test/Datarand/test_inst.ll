...
entry:
  ...
  %2 = getelementptr [9 x i8], [9 x i8]* @.str, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %2, i32 %1), !dbg !30
  %3 = load %struct.Student*, %struct.Student** %sptr.addr, align 8, !dbg !31
  %name = getelementptr inbounds %struct.Student, %struct.Student* %3, i32 0, i32 1, !dbg !32
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* %4, i8* %arraydecay), !dbg !33
  ret void, !dbg !34
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* %4, i32 %3), !dbg !52
  ret void, !dbg !53
}
...
entry:
  ...
  %4 = getelementptr [4 x i8], [4 x i8]* @.str.2, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %4, i32 %3), !dbg !69
  ret void, !dbg !70
}
...
entry:
  ...
  %0 = call i64 @encrypt_globals(i8* bitcast (i32* @val1 to i8*), i64 4)
  %1 = call i64 @encrypt_globals(i8* bitcast (i32* @val2 to i8*), i64 4)
  ...
  %2 = getelementptr [10 x i8], [10 x i8]* @.str.3, i32 0, i32 0
  %3 = getelementptr [7 x i8], [7 x i8]* @.str.4, i32 0, i32 0
  call void @llvm.var.annotation(i8* %iptr1, i8* %2, i8* %3, i32 46), !dbg !101
  ...
  %4 = load i32, i32* %k, align 4, !dbg !106
  %add = add nsw i32 %4, 10, !dbg !107
  store i32 %add, i32* %j, align 4, !dbg !105
  call void @printStudent(%struct.Student* %stud), !dbg !108
  %5 = load i32, i32* %k, align 4, !dbg !109
  %6 = load i32, i32* %j, align 4, !dbg !110
  %7 = getelementptr [6 x i8], [6 x i8]* @.str.5, i32 0, i32 0
  %call = call i32 (i8*, ...) @printf(i8* %7, i32 %5, i32 %6), !dbg !111
  %8 = load i32, i32* %j, align 4, !dbg !112
  %cmp = icmp slt i32 %8, 100, !dbg !114
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %9 = load void (i32)*, void (i32)** %funcptr3, align 8, !dbg !128
  call void %9(i32 23), !dbg !129
  ret i32 0, !dbg !130
}

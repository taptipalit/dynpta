...
$LLVMROOT/opt -encryption -steens-fast -skip-csa=true -skip-vfa -callsite-threshold=10 -optimized-check=false -confidentiality=true -partitioning=true  $file.bc -o $fileinst.bc

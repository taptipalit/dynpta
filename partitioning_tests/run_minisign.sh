...
$LLVMROOT/opt -encryption -steens-fast -skip-csa=false -skip-vfa=true -callsite-threshold=10 -optimized-check=true -confidentiality=true -hoist-taint-checks=true -partitioning=true  $file.bc -o $fileinst.bc

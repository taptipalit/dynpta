...
$LLVMROOT/opt -encryption -steens-fast -skip-csa=false -skip-vfa=false -callsite-threshold=10 -optimized-check=false -confidentiality=true -partitioning=true  $file.bc -o $fileinst.bc

...
$LLVMROOT/opt -encryption -steens-fast -confidentiality=true -skip-vfa=true -skip-csa=true -optimized-check=false -partitioning=true -hoist-taint-checks=false $filewithlibc.bc -o $fileinst.bc

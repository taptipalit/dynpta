...
LLVMROOT=/home/jfmoon/LLVM-custom/build/bin
...
$LLVMROOT/opt -encryption -partitioning=false -debug-only=encryption  $file.bc -o $fileinst.bc 
...
$LLVMROOT/clang  $GGDB aes_inmemkey.s aes_helper.c $fileinst.o -o $file
if [ $? -ne 0 ]
then
    exit 1
fi
